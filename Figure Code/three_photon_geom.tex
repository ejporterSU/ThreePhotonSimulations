...
% Main cloud body
\shadedraw[ball color=blue!55!cyan, opacity=0.75] (0,0) circle (0.4);
...
\draw[{Stealth[scale=0.7]}-{Stealth[scale=0.7]}, c679, line width=1.8pt, font=\large]
...
\draw[c688, line width=0.1pt, fill=c688, font=\large]
...
\draw[c689, line width=0.1pt, fill=c689, font=\large]
...
% =======================================================
\node[anchor=north east, inner sep=6pt] at (5.7, 3.3) {
  \includegraphics[width=4cm]{doppler_free.pdf}
};
