...
def make_figure():
    ...
    pi_times3  = np.array([2, 4, 6, 9.5, 22, 38, 75, 249, 900]) * 1e-6
    omega_3v   = (PI / pi_times3) / (2*PI)
    lw_3v_khz  = np.array([328, 187, 155, 77.2, 31.4, 21.8, 8.7, 2.64, 0.874])
    lw_3v_err = np.array([46,22.5,16.4,8.6,1.8,1.4,0.37,0.11,0.043])
    ...
    # # ── Panel (b) data ─────────────────────────────────────────────────────────
    f_narrow=np.array([-1.50e-03, -1.45e-03, -1.40e-03, -1.35e-03, -1.30e-03, -1.25e-03,
       -1.20e-03, -1.15e-03, -1.10e-03, -1.05e-03, -1.00e-03, -9.50e-04,
       -9.00e-04, -8.50e-04, -8.00e-04, -7.50e-04, -7.00e-04, -6.50e-04,
       -6.00e-04, -5.50e-04, -5.00e-04, -4.50e-04, -4.00e-04, -3.50e-04,
       -3.00e-04, -2.50e-04, -2.00e-04, -1.50e-04, -1.00e-04, -5.00e-05,
        ...
        1.50e-03])*10**6
    pop_narrow = np.array([0.02424568, 0.01916857, 0.0338724 , 0.02172378, 0.02247482,
       0.03002194, 0.02304881, 0.02475772, 0.02953832, 0.02093035,
       0.02291982, 0.02446813, 0.02970763, 0.02011007, 0.04059985,
       0.03014043, 0.04568448, 0.03409942, 0.02834185, 0.05139086,
       0.04382774, 0.0554667 , 0.17032737, 0.07225814, 0.096193  ,
       0.38098492, 0.45398876, 0.26694607, 0.42480787, 0.76774327,
       0.77593274, 0.769165  , 0.53262039, 0.36803078, 0.30142386,
       0.19321071, 0.13200785, 0.14146923, 0.11513769, 0.0986383 ,
       0.09210161, 0.10172677, 0.05760082, 0.0441885 , 0.0496661 ,
       0.03678891, 0.03821625, 0.03521852, 0.04769266, 0.03617213,
       0.02972072, 0.02708626, 0.02020643, 0.02578234, 0.03004258,
       0.0298629 , 0.04266721, 0.03333042, 0.03225679, 0.0404235 ,
       0.01853684])
